 ...
 */
public final class Keyboard implements Keys {
    ...
    private static boolean[] downKeys;
    private static boolean[] upKeys;
    ...
    public static void init() throws LWJGLException {
        ...
        Keyboard.currentKeys = new boolean[NUM_KEYCODES];
        Keyboard.downKeys = new boolean[NUM_KEYCODES];
        Keyboard.upKeys = new boolean[NUM_KEYCODES];
    }
    ...
    public static void update() {
        for (short key = 0; key < NUM_KEYCODES; key++) {
            boolean isDown = org.lwjgl.input.Keyboard.isKeyDown(key);
            if (isDown) {
                downKeys[key] = !currentKeys[key];
            } else {
                upKeys[key] = currentKeys[key];
            }
    ...
    public static boolean isKeyDown(int keyCode) {
        return Keyboard.currentKeys[keyCode];
    }

    /**
     * Checks whether a certain key is down.
     *
     * @see engine.Keyboard#isKeyDown(int)
     * @see org.lwjgl.input.Keyboard#isKeyDown(int)
     *
     * @throws DwarfException illegal argument, keyName not recognised.
     *
     * @param keyName the name of the key to be tested
     * @return true if the key is down, otherwise it will return false.
     */
    public static boolean isKeyDown(String keyName) throws DwarfException {
     ...
     * when a key is pressed.
     *
     * @see enigne.Keyboard#isKeyPressed(int)
     *
     * @throws DwarfException illegal argument, keyName not recognised.
     *
     * @param keyName the name of the key to be tested
     * @return if a key is pressed down for that frame (bool)
     */
    public static boolean isKeyPressed(String keyName) throws DwarfException {
        return Keyboard.isKeyPressed(getKeyCode(keyName));
    }
    ...
    public static boolean isKeyReleased(int keyCode) {
        return Keyboard.upKeys[keyCode];
    }
     ...
     * released.
     *
     * @see enigne.Keyboard#isKeyReleased(int)
     *
     * @throws DwarfException illegal argument, keyName not recognised.
     *
     * @param keyName the name of the key to be tested
     * @return if a key is released up for that frame (bool)
     */
    public static boolean isKeyReleased(String keyName) throws DwarfException {
        return Keyboard.upKeys[getKeyCode(keyName)];
    }
