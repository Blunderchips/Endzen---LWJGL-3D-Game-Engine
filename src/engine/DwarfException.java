...
/**
 * This exception is supplied to make exception handling more generic for Dwarf
 * specific exceptions.
 *
 * @author Matthew 'siD' Van der Bijl
 *
 * @see enigne.Crashform
...
public class DwarfException extends java.lang.RuntimeException implements Cloneable {
     ...
     * <code>DwarfException</code> without detailed message.
     */
    ...
    public Crashform Crachform() {
        return new Crashform(this);
    }

    public void display() {
        JOptionPane.showMessageDialog(
                null, this, this.getMessage(), JOptionPane.ERROR_MESSAGE);
    }
}
